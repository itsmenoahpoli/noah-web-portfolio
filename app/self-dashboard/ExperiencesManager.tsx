      ...
      {sortedExperiences.length === 0 ? (
        ...
        <div className="space-y-0">
          {sortedExperiences.map((exp, index) => {
            ...
            return (
              <div key={exp.id} className="group relative flex gap-4 pb-6 last:pb-0">
                <div className="relative flex w-10 shrink-0 justify-center">
                  {index < sortedExperiences.length - 1 && (
                    <div className="absolute top-10 bottom-0 w-px bg-gray-200 dark:bg-gray-800" />
                  )}
                  <div className="relative mt-1 flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-slate-950">
                    <HiOutlineCalendarDays className="h-4 w-4 text-gray-500 dark:text-gray-300" />
                  </div>
                </div>
                ...
                <div className="flex-1 rounded-2xl border border-gray-100 bg-white p-4 transition-all hover:border-gray-300 dark:border-gray-800 dark:bg-white/5 dark:hover:border-gray-600">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-col gap-3 lg:items-end">
                      ...
                      <div className="flex items-center space-x-4 opacity-0 transition-opacity group-hover:opacity-100">
                        <button
                          onClick={() => {
